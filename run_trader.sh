...
# This allows interactive confirmation while logging everything
python oanda_production_trader.py --pair EURUSD --live 2>&1 | tee -a /home/forex/logs/trader_$(date +%Y_%m_%d).log
