...
class NotificationService:
    ...
    def __init__(self):
        ...
        if not self.sms_enabled and not self.telegram_enabled:
            print("⚠️  WARNING: No notification services configured")
...
if __name__ == "__main__":
    ...
    print(f"\nSMS enabled: {notifier.sms_enabled}")
    print(f"Telegram enabled: {notifier.telegram_enabled}")

    if notifier.sms_enabled or notifier.telegram_enabled:
        ...
        print("\nTo enable SMS (Twilio), add to .env:")
        print("  TWILIO_ACCOUNT_SID=your_account_sid")
        print("  TWILIO_AUTH_TOKEN=your_auth_token")
        print("  TWILIO_FROM_NUMBER=+1234567890")
        print("  TWILIO_TO_NUMBER=+1234567890")
