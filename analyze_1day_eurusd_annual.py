"""
Analyze annual performance for 1-day EURUSD model with optimized thresholds
...
print("1-DAY EURUSD ANNUAL PERFORMANCE ANALYSIS")
print("="*80)
...
for window_idx, window_results in enumerate(all_results):
    ...
    # Use OPTIMIZED thresholds (48/52 for EURUSD)
