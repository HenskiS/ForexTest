"""
Train XGBoost on 4-hour forex data with bar-based walk-forward validation.

Usage:
    python train_xgboost_4hour.py --pair EURUSD --n_iter 20
    python train_xgboost_4hour.py --pair GBPUSD --n_iter 20
"""
...
N_ITER = args.n_iter
TARGET_COLUMN = 'target_1day_return'  # Predict 6 bars ahead (1 day)

print(f"Training XGBoost on 4-hour {CURRENCY_PAIR} data")
...
# Smaller windows for higher-frequency 4-hour trading (half of daily equivalent)
TRAIN_BARS = 1800  # 300 days × 6 bars/day
VAL_BARS = 468     # 78 days × 6 bars/day
TEST_BARS = 378    # 63 days × 6 bars/day
ROLL_BARS = 378    # Roll forward by 378 bars (63 days)
...
output_file = f'xgboost_results_{CURRENCY_PAIR}_4hour_target_1day_return.pkl'
...
print("="*70)
print(f"\nNext step: Backtest with backtest_advanced_exits_4hour.py")
