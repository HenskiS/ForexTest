...
if len(sys.argv) < 2:
    print("Usage: python monte_carlo_pair.py <CURRENCY_PAIR>")
    sys.exit(1)

CURRENCY_PAIR = sys.argv[1].upper()

print(f"MONTE CARLO SIMULATION - {CURRENCY_PAIR}")
print("="*80)
...
# Print results
print("\n" + "="*80)
print(f"MONTE CARLO RESULTS - {CURRENCY_PAIR} (10,000 simulations)")
print("="*80)
...
# Save results
output_file = f'monte_carlo_results_{CURRENCY_PAIR}.json'
