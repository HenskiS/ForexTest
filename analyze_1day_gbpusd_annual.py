"""
Analyze annual performance for 1-day GBPUSD model with optimized thresholds
...
print("1-DAY GBPUSD ANNUAL PERFORMANCE ANALYSIS")
print("="*80)

# Load data
df = pd.read_csv('data/GBPUSD_1day_with_features_FIXED_multitarget.csv',
...
# Load predictions
with open('xgboost_results_GBPUSD_target_5day_return.pkl', 'rb') as f:
...
def generate_signals_optimized(predictions, lower_pct=48, upper_pct=52):
    """Generate signals using optimized thresholds (48th/52nd percentile for GBPUSD)."""
...
for window_idx, window_results in enumerate(all_results):
    ...
    # Use OPTIMIZED thresholds (48/52 for GBPUSD)
