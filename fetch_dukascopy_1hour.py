"""
Fetch 1-hour forex data from Dukascopy Bank SA

Usage:
    python fetch_dukascopy_1hour.py EURUSD
    python fetch_dukascopy_1hour.py GBPUSD
"""
...
if len(sys.argv) < 2:
    print("Usage: python fetch_dukascopy_1hour.py <CURRENCY_PAIR>")
    print("Example: python fetch_dukascopy_1hour.py EURUSD")
    sys.exit(1)
...
print(f"{'='*80}")
print(f"FETCHING 1-HOUR DATA FROM DUKASCOPY - {CURRENCY_PAIR}")
print(f"{'='*80}\n")
...
try:
    ...
    # Save to CSV
    output_file = f'data/{CURRENCY_PAIR}_1hour_dukascopy.csv'
    ...
    print(f"\nNext step: Add technical features using add_features_1hour.py")
